...
function draw() {
    ...
    slider1.addEventListener("input", drawPolygon);
    slider2.addEventListener("input", drawPolygon);
    slider3.addEventListener("input", drawPolygon);
    drawPolygon();
...
function drawAnother() {
    ...
    slider1_1.addEventListener("input", drawPolygon1);
    slider2_1.addEventListener("input", drawPolygon1);
    slider3_1.addEventListener("input", drawPolygon1);
    drawPolygon1();
